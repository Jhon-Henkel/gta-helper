...
export const saLosSantosMissionsPartOne: Array<IMissionItem> = [
    ...
    {
        title: "3 - Ryder",
        description: "Entre no carro com Ryder e vá ao cabeleireiro, faça um penteado bem loco e depois entre na " +
        ...
        icon: `${iconsDir}rider.jpg`,
    },
    {
        title: "4 - Marcando Território",
        description: "Entre no carro com Sweet e vá até o ponto marcado. Depois da demonstração de Sweet com o " +
            "spray, use R1 para mirar e O para pichar a parede da casa em frente e do beco logo atrás. Siga para " +
            "East Los Santos piche a parede onde tem uma mulher desenhada, no corredor ao lado mate os gangsters e " +
        ...
        icon: `${iconsDir}sweet.jpg`,
    },
    {
        title: "5 - Limpando as Ruas",
        description: "Entre no carro com Ryder e siga até a casa de B-Dup, depois de falar com ele, siga até a casa " +
            "indicada, mate o traficante usando: R1 = mira, O = soco, triângulo = soco especial, quadrado = defesa. " +
    ...
    },
    {
        ...
        description: "Vá até a casa de Emmet para treinar tiro ao alvo com Smoke. Aperte R1 para mirar, O para " +
    ...
    },
    {
        ...
        description: "Vá até o ponto indicado com a sua gangue. Passe devagar pelas gangues pra que seus amigos " +
    ...
    },
    {
        ...
        description: "Corra para a casa da namorada de Sweet e mate os gangsters que estão incomodando por lá. " +
    ...
    },
    {
        ...
        description: "Vá até a garagem indicada no mapa e tune o Low Rider. Leve-o para a competição de Low Riders e " +
    ...
    },
    {
        ...
        description: "Essa é a 1ª missão de roubar casas. Siga para a casa indicada no mapa, entre e pegue as 6 " +
            "caixas dentro da casa (1 na sala ao lado do canhão, 1 na cozinha, 2 no corredor do 2º andar e 2 no " +
    ...
    },
    {
        ...
        description: "Siga para o ponto no mapa, onde há uma briga entre sua gangue e uma inimiga, mate os inimigos " +
    ...
    },
    {
        ...
        description: "Corra para o ponto indicado no mapa, mate o guarda e destrua o painel para abrir o portão e " +
            "o outro painel pra abrir a porta do depósito. Pegue a empilhadeira e use o R3 para mexer os garfos " +
    ...
    },
    {
        ...
        description: "Vá com Big Smoke até a estação de trem indicada no mapa. Pegue a moto e siga ao lado do trem " +
    ...
    },
    {
        ...
        description: "Leve Big Smoke até o local indicado em Downtown, dê cobertura pra ele e mate os guardas, " +
    ...
    },
    {
        ...
        description: "Corra para uma festa que está rolando na praia, fale com a DJ, aceite o convite para dançar " +
        ...
        rewards: "Respeito",
        icon: `${iconsDir}ogLoc.jpg`,
    },
    {
        title: "20 - As Rimas do Madd Dog",
        description: "Nessa missão você terá que pegar o livro de rimas de Madd Dog, vá até a casa dele e entre " +
            "pela porta dos fundos, para matar os guardas aperte L3 para agachar, ande até o guarda e mire com R1, " +
    ...
    },
    {
        ...
        description: "Nessa missão você terá que roubar um carro especial para pegar uma celebridade. Corra para a " +
            "lanchonete onde o motorista está com o carro, pegue o carro (se estiver quebrado leve até o Pay n’ " +
            "Spray pra consertar) e leve ao local indicado antes das 10 da noite. Estacione entre os outros 2 carros " +
            "e siga entre eles até o local indicado. Depois que o artista (muito parecido com Will Smith) entrar no " +
    ...
    },
    {
        ...
        description: "Fale com OG Loc para marcar uma festa ás 8 da noite, durante o dia aproveite o tempo para " +
            "mudar o visual de CJ, compre roupas e corte o cabelo. Chegadas as 8 horas vá até o local da festa. " +
    ...
    },
    {
        ...
        description: "Pegue o coquetel molotov no beco. Siga para a casa indicada no mapa e jogue os coquetéis " +
            "pelas janelas da casa. Uma garota pede socorro, ela está dentro da casa em chamas! Entre lá e salve-a! " +
    ...
    },
    {
        ...
        description: "Siga para as docas e mate todos na parte de fora do depósito, cuidado com as empilhadeiras " +
            "com explosivos. Destrua o painel na porta e entre no depósito, vá matando todo mundo até chegar ao " +
    ...
    {
        title: "25 - Doberman",
        description: "Vá à loja de armas, nessa missão você terá que conquistar um território dos Ballas, compre " +
            "umas armas e siga para Glen Park, mate alguns gangsters para provocar uma guerra entre as gangues. " +
    ...
    },
    {
        ...
        description: "Nessa missão você terá que recrutar amigos da sua gangue (os caras de roupa verde) para " +
            "ajudá-lo no serviço. Recrute os 2 caras que estão na rua (Aperte R1 para mirar e /\\ para recrutar os " +
            "caras), agora vá até o cemitério com todos dentro do carro, chegando lá dê instruções para seus amigos " +
            "(use /\\ para eles te seguirem, \\/ para ficarem na posição e segure /\\ ou \\/ por algum tempo para " +
    ...
    },
    {
        ...
        description: "Corra para o motel, Sweet entra no motel para resolver umas paradas e você e seus amigos " +
            "ficam esperando do lado de fora. Mas a polícia chega para dar uma “limpa” no lugar, seus amigos fogem " +
            "e você terá que entrar e salvar seu irmão Sweet. Vá matando os policiais e entrando nos quartos para " +
            "beijar as prostitutas, recuperando assim a energia. No lado de fora, mate os policiais que estão no " +
    ...
    },
    {
        ...
        description: "Depois do telefonema de César siga para o ponto de encontro e entre no carro dele. Na cena " +
            "seguinte você vê Smoke e Ryder sendo comprados com um Sabre verde, pelo policial Tenpenny e os Ballas. " +
