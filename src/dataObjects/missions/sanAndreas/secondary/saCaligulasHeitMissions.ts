...
export const saCaligulasHeitMissions: Array<IMissionItem> = [
    ...
    },
    {
        ...
        description: "Precisa de um cartão de acesso ao casino \"Calígula\". Vá para o ponto especificado. Vai atrás " +
            "do stickman, vai para a SexShop. Veste um fato e segue-a até à casa dela. Mate o sem teto, pega na " +
    ...
    },
    {
        ...
        description: "É necessário desligar a eletricidade. Passe o avião pelo ponto de controle sobre a " +
            "barragem. Salte para fora e pouse no local especificado. Vai lá abaixo, pega uma faca, ou usa uma " +
    ...
    },
    {
        ...
        description: "Temos que roubar um carro blindado. Vá para a fábrica militar. Quando o portão se abrir, " +
            "entre. Mate todos no território, vá para a metralhadora e abata os dois helicópteros militares. " +
    ...
    },
    {
        ...
        description: "O acesso à missão de assalto abre-se quando pegar o cartão da Millie. Vai ao edifício do " +
            "casino. Vá ao escritório, atire uma granada de gás para a ventilação, abra o portão com a ajuda da " +
            "empilhadeira, ao longo do caminho mate todos os guardas da máfia. Vai ao cofre e destrói os geradores. " +
            "Quando todo o dinheiro é coletado, garanta uma saída segura do edifício, seja a distração e chame a " +
            "atenção para si mesmo. Vá para o telhado e abata o helicóptero. Pegue um pára-quedas e pule para o " +
